...
import star_svg from "../public/star.svg";
import Button from "./Button";
import play_svg from "../public/play.svg";
import close_svg from "../public/close.svg";
            ...
            <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
                ...
                <div className="my  -11 flex flex-wrap gap-5">
                    ...
                    <div className="flex flex-col w-full gap-3 sm:flex-row">
                        ...
                        <Button type="button" title="How we work?" icon={play_svg} variant="btn_white_text"/>
                    </div>
                </div> 

                
            </div>
            <div className="relative flex flex-1 items-start mt-[-60px] ">
